...
function Button({ buttonText, variant }) {
  ...
  return (
    <button className="relative flex items-center justify-center w-48 h-12 p-2 overflow-hidden font-extrabold duration-300 border rounded-md cursor-pointer bg-gradient shadow-500 hover:scale-95 group text-sky-50">
      ...
      <p className="z-10 text-black">{buttonText}</p>
    </button>
  );
}
